 ...
 *
 * @param collectableImage The image identifier for a collectable item present in the game location. This can be {@code null}
 *                         if no collectable is present.
 * @param structureImage The image identifier for a structure present in the game location. This can be {@code null}
 *                       if no structure is present.
 * @param landImage The image identifier for the land or terrain present in the game location. This can be {@code null}
 *                  if the location does not involve explicit land or terrain imagery.
 */
