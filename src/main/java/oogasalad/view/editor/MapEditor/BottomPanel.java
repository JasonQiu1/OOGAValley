...
public class BottomPanel extends TabPane {
  public BottomPanel(Selector ts) {
    ...
    buildingsTab.setContent(new SelectableViewsWrapper(new SelectableViews(mockBuildings, ts), "Buildings"));
  ...
  private List<SelectableView> getMockNature() throws MalformedURLException {
    ...
    SelectableView t2 = new NatureView(new ImageView(new Image(
            String.valueOf(new File("src/main/resources/img/boulder.png").toURI().toURL()))), "Boulder");
    temp.add(t2);
    return temp;
  }
  ...
  private List<SelectableView> getMockPlants() throws MalformedURLException {
    ...
    SelectableView t1 = new PlantView(new ImageView(new Image(
            String.valueOf(new File("src/main/resources/img/watermelonplant.png").toURI().toURL()))), "Watermelon");
    temp.add(t1);
    ...
    SelectableView t3 = new PlantView(new ImageView(new Image(
            String.valueOf(new File("src/main/resources/img/sunflower.png").toURI().toURL()))), "Sunflower");
    temp.add(t3);
    return temp;
  }
