...
public class MapPropertiesContainer extends HBox {
    ...
    public MapPropertiesContainer(String mapPropertyName, Consumer<String> addMapProperty, Consumer<String> removeMapProperty){
        ...
        AddPropertyButton addPropertyButton = new AddPropertyButton("Add", addMapProperty, mapPropertyName);
        AddPropertyButton removePropertyButton = new AddPropertyButton("Remove", removeMapProperty, mapPropertyName);
