...
/**
 * The SaveAllButton class represents a button to save all changes in the editor.
 * It triggers a confirmation dialog before saving.
 */
public class SaveAllButton extends Button {

    /**
     * Constructs a SaveAllButton with a specified game configuration and a supplier to get the file name.
     *
