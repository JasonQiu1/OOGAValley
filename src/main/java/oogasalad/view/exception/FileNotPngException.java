package oogasalad.view.exception;

public class FileNotPngException extends Exception {
   ...
   */
  public FileNotPngException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public FileNotPngException(String message, Throwable cause) {
    super(message, cause);
  }
}
