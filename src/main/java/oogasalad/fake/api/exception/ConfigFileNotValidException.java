package oogasalad.fake.api.exception;

public class ConfigFileNotValidException extends Exception {
   ...
   */
  public ConfigFileNotValidException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public ConfigFileNotValidException(String message, Throwable cause) {
    super(message, cause);
  }
}
